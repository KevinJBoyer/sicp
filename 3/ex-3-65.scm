...
(stream-print-first ln-2-stream 5)
(display-line "")
(stream-print-first (euler-transform ln-2-stream) 5)
(display-line "")
(stream-print-first (accelerated-sequence euler-transform ln-2-stream) 5)

(display-line "")
(stream-print-first (accelerated-sequence euler-transform (accelerated-sequence euler-transform ln-2-stream)) 5)