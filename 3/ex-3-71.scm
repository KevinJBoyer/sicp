...
;(stream-print-first
; (stream-duplicate-pairs (weighted-pairs-i-less-j integers integers weight-by-sum-of-cubes) weight-by-sum-of-cubes)
; 10)


(stream-print-first
 (stream-filter (lambda (x) (and (eq? (car x) 9) (eq? (cadr x) 10))) (pairs-i-less-j integers integers))
 1)