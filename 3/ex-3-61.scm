...
(define some-series (stream-from-list (list 1 2 3 4 5)))
(define invert-of-some-series (invert-unit-series some-series))
(stream-print-first (mul-series some-series invert-of-some-series) 4)