...
(define rect2 (make-from-mag-ang 8 (/ 3.141592 8)))
...
(test "rectangular make-from-mag-ang"
      rect2
      (cons 'rectangular (cons 7.391036510208255 3.0614668550824753)))
...
(test "rectangular angle" (angle rect2) 0.39269899999999996)